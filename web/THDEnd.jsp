...
//       String query = " update into requests " + " values ("+status + "," +comment+ ");
       ...
       String query = "update requests set statustran = " + "'" +status + "'" + " where r_id = " + id  ;
...
//      System.out.println("Hey"); 
      ...
      String to="suryanshchoudhary.nmims@gmail.com";//change accordingly  
  ...
  Session session1 = Session.getDefaultInstance(props,  
   ...
   return new PasswordAuthentication("suryansh.dynamism@gmail.com","indianmilitaryacademy");//change accordingly  
   }  
  });  
  ...
  try {  
   ...
   message.setFrom(new InternetAddress("suryansh.dynamism@gmail.com"));//change accordingly  
  ...
  out.println("Operation Performed");
